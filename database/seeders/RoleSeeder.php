...
class RoleSeeder extends Seeder
{
        ...
        public function run()
        {
                ...
                $roles = [
                        ...
                        [
                                'id' => 7,
                                'role' => 'Admin. Control de Vales',
                                'description' => 'Rol dedicado personal de control Vehícular para aprobar vales.',
                        ...
                        [
                                'id' => 8,
                                'role' => 'Director-Solicitador', #'Solicitador de Vales',
                                'description' => 'Rol dedicado para permisos de Director y solicitar Vales.', #'Rol dedicado unicamente para solicitar Vales.',
                                'read' => '1,2,3,12,15,17,19,23,24,25,24', #'25,24',
                                'create' => '24',
                                'update' => '',
                                'delete' => '',
                                'more_permissions' => 'Prestar Vehículo,Entregar Vehículo,Solicitar Servicio,Devolver Préstamo,Cancelar Vale,', #'Cancelar Vale',
                                'page_index' => '/admin/vales',
                                'active' => 1,
                                'created_at' => '2024-03-19 19:19:16',
